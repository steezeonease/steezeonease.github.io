...
export const PrepDoc = () => {
  return (
    <ProjectPage
      ...
      projectBackground={require("../../../images/careercafe.jpg")}
      imageOpacity={0.4}
    >
      <>
          ...
          <>
            ...
            <ul>
              <li>
                ...
                medical terminology definitions, or even writing down questions to ask their doctor
              </li>
              <li>
                Patients <strong>find it difficult to explain</strong> their medical problem or
                concern to their doctor due to a language barrier or not knowing the correct medical
                terminology to use
              </li>
              <li>
                Patients <strong>feel nervous at the doctor's office</strong> because they are there
                for a medical concern — usually something bad
              </li>
            </ul>
